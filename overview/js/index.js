...
// escopo global
//const x = 10  
let x = 10 //usa let para trabalhar escopos 
if(true){
    // escopo local
    let x = 20
    //console.log(x) imprime o 20 pois pega o valor da qual tem o escopo mais próximo, local.
    console.log(this.x) //andando no escopo de fora desse que está, imprime o 10
}
// x = "5"
...
const {n1, n2, n3, n4, n5} = vetorv

const vetorJson = JSON.stringify(vetor)
...
const jsonObject = JSON.stringify(calcular);
...
const vari1 = 5;
const vari2 = 10;
console.log(`Quinze é ${(var1 + var2)}, e não ${(2 * vari1 + vari2)}.`);
...
function myArrowFunction2 (a, b) {
    return a + b
}
console.log(myArrowFunction2( 5, 2))
...
Product.test() //serve evitar precisar instanciar classe
...
console.log(document.getElementById('titulo')) //document eé o objeto nativo que percorre no DOM
...
//faz alguma alteração, troca o conteudo do titulo 
// manipula o conteúdo de um elemento
texts[0].textContent = 'Estou alterando o título.'

//devolve uma alteração para o html
//escreve dentro do h1
...
texts[1].style.backgroundColor = 'pink'
...
button.addEventListener('click',()=>(texts[0].style.backgroundColor='purple')) //se ativa sozinha
//não tem assinatura, sem referencia
